...
class Discretizacao:
    ...
    def rungekutta_planetas(self, corpo_1, corpo_2, corpo_3, n, T):
        ...
        while t < 20*T:
            ...
            kv2_1 = nova_ac(corpo_1, corpo_2, corpo_3, h/2, kr1_1, kr1_2, kr1_3,  kv1_1, kv1_2, kv1_3)

            kr2_2 = v(corpo_2) + h*kv1_2/2
            kv2_2 = nova_ac(corpo_2, corpo_1, corpo_3, h/2, kr1_2, kr1_1, kr1_3, kv1_2, kv1_1, kv1_3)

            kr2_3 = v(corpo_3) + h*kv1_3/2
            kv2_3 = nova_ac(corpo_3, corpo_1, corpo_2, h/2, kr1_3, kr1_1, kr1_2, kv1_3, kv1_1, kv1_2)

            #K3
            kr3_1 = v(corpo_1) + h*kv2_1/2
            kv3_1 = nova_ac(corpo_1, corpo_2, corpo_3, h/2, kr2_1, kr2_2, kr2_3, kv2_1, kv2_2, kv2_3)

            kr3_2 = v(corpo_2) + h*kv2_2/2
            kv3_2 = nova_ac(corpo_2, corpo_1, corpo_3, h/2, kr2_2, kr2_1, kr2_3, kv2_2, kv2_1, kv2_3)
            
            kr3_3 = v(corpo_3) + h*kv2_3/2
            kv3_3 = nova_ac(corpo_3, corpo_1, corpo_2, h/2, kr2_3, kr2_1, kr2_2, kv2_3, kv2_1, kv2_2)

            #K4
            kr4_1 = v(corpo_1) + h*kv3_1
            kv4_1 = nova_ac(corpo_1, corpo_2, corpo_3, h, kr3_1, kr3_2, kr3_3, kv3_1, kv3_2, kv3_3)

            kr4_2 = v(corpo_2) + h*kv3_2
            kv4_2 = nova_ac(corpo_2, corpo_1, corpo_3, h, kr3_2, kr3_1, kr3_3, kv3_2, kv3_1, kv3_3)

            kr4_3 = v(corpo_3) + h*kv3_3
            kv4_3 = nova_ac(corpo_3, corpo_1, corpo_2, h, kr3_3, kr3_1, kr3_2, kv3_3, kv3_1, kv3_2)
